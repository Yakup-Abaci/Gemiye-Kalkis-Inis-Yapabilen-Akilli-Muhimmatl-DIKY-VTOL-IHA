...
# Örnek kullanım
#, lon1 = 40.2277765, 29.0097857  # New York'un koordinatları
#lat2, lon2 = 40.240521, 28.9912462  # Los Angeles'in koordinatları
...
#yatay_metre = haversine(lat1, lon1, lat2, lon1)
    ...
    def gonder(self):
        vehicle= mavutil.mavlink_connection('tcp:127.0.0.1:5762', baud=115200)
        """s = socket.socket(
