...
class Drone:
    ...
    def takeoff(self, altitude):
        self.vehicle.mav.command_long_send(
            ...
            10,  # param2 (all other params meaningless)
            0,  # param3
            0,  # param4
            0,  # param5
            0,  # param6
            altitude)  # param7
        while True:
            konum = self.vehicle.recv_match(type="GLOBAL_POSITION_INT",blocking=True)
            if konum.relative_alt*0.001 > altitude*0.95:
                print("yüksekliğe ulaşıldı")
                break
            else:
                print(konum.relative_alt*0.001)
    ...
    def vtol_takeoff(self, altitude):
        ...
        self.vehicle.mav.command_long_send(
            ...
            0,  # confirmation
            0,  # param1 (1 to indicate arm)
            180,  # param2 (all other params meaningless)
            0,  # param3
            0,  # param4
            0,  # param5
            0,  # param6
            konum.alt + 15000)  # param7
        while True:
            konum = self.vehicle.recv_match(type="GLOBAL_POSITION_INT",blocking=True)
            if konum.relative_alt*0.001 > altitude*0.95:
                print("yüksekliğe ulaşıldı")
                ...
                print(self.vehicle.recv_match(type="LOCAL_POSITION_NED",blocking=True))
